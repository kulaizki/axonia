<script lang="ts">
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Directly load and render files in the popular NIfTI format without any preprocessing steps.'
    },
  ];
</script>

<section id="features" class="relative min-h-screen bg-gray-950 flex items-center py-16 lg:h-screen lg:py-0 border-b-2 border-emerald-500 shadow-[0_1px_3px_0_rgba(16,185,129,0.5)]">
  <div 
  ...
  >
    ...
    <div class="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-5xl">
      <div class="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 text-center lg:max-w-none lg:grid-cols-3">
